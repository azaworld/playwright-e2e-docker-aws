// Test script to show Teams card structure
...
const teamsCard = {
  ...
  'themeColor': metrics.failed === 0 ? '00FF00' : 'FF0000',
  'title': `${status_emoji} ${portalName} - ${status_message}`,
  'text': teamsMsg,
  'sections': [
    {
      'activityTitle': 'Test Results Summary',
      'activitySubtitle': `Date: ${dateStr}`,
      'text': teamsMsg,
      'markdown': true
    }
  ]
...
console.log('=== TEAMS CARD STRUCTURE ===');
console.log('');
console.log(JSON.stringify(teamsCard, null, 2));
console.log('');
console.log('=== END CARD STRUCTURE ===');
console.log('');
console.log('=== MESSAGE TEXT ONLY ===');
console.log('');
console.log(teamsMsg);
console.log('');
console.log('=== END MESSAGE TEXT ==='); 